...
if __name__ == "__main__":
    #text = "Colored copies cost 10 cents per copy and white copies cost 5 cents per copy. Sandy made 400 copies , some of which were colored and the rest white. Her total bill was 22.50 dollars. How many colored copies and white copies did she make?"
...
df = pd.read_json('../svamp700_selected_questions.json')

all_questions = df['sQuestion'].tolist()

f = open("../svamp700_all_generated_questions.txt", "w")
