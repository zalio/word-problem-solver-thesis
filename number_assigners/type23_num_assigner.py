...
def read_type23_questions():
    return read_all_questions_from_file("type_23.txt", Type23Question,
                                        fix_solution_function=fix_solution_numbers_order)


if __name__ == "__main__":
    all_type23_questions = read_type23_questions()
    acc_value = test_all_same_type_questions(all_type23_questions, "23")
    print("\n", "~" * 100, "\n====> Accuracy Value for Type 23 Questions =", acc_value * 100, "%")
