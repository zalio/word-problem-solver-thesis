...
def find_closest_numbers_with_most_in_common_words(prioritized_numbers, words_after_each_number):
    ...
    if len(best_i_j_pairs) == 1:
        ...
        for s in best_i_j_pairs:
            split_s = s.split(" ")
            differences_between_i_and_j.append(abs(float(split_s[0]) - float(split_s[1])))
...
def read_type3_questions():
    return read_all_questions_from_file("../organized_questions/type_3.txt", Type3Question,
